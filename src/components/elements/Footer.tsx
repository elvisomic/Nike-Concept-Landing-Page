    ...
    <footer className="bg-white h-100 w-screen p-4 relative bottom-0">
        ...
        <div className=" grid grid-cols-1 grid-rows-4 gap-y-8 md:grid-cols-4 md:grid-rows-1 lg:grid-cols-6 lg:ml-16 xl:ml-25" >
            ...
            <div className="lg:mr-16 xl:mr-5">
                ...
                <img src="/Nike-Concept-Landing-Page/assets/logonike.png" className="hidden md:block m-auto mt-8 h-10 ml-5" alt="Image showing Nike Logo" />
        ...
        <img src="/Nike-Concept-Landing-Page/assets/logonike.png" className="inline-block h-10 md:hidden" alt="Image showing Nike Logo" />
