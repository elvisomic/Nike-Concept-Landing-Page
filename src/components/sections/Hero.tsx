...
export const Hero = () => {
    ...
    <div className="mt-5">
        <div className="h-180 relative">
            ...
            <img className="motion-preset-conefetti 2xl:left-10 relative xl:h-175 xl:left-[-150px] xl:top-5 z-30 h-120 right-15 top-20 lg:top-25 lg:left-[-50px] md:top-[-20px] md:left-20 rotate-340" src="/Nike-Concept-Landing-Page/assets/tike2.png" alt="Hero image of Nike Air Jordan sneakers" />
